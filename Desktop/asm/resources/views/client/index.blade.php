                ...
                <div class="col-md-12">
                    <div class="nonloop-block-3 owl-carousel">
                        <div class="item">
                            <div class="block-4 text-center">
                                <figure class="block-4-image">
                                    <img src="/client/images/anh1.jpg" alt="Image placeholder" class="img-fluid">
                                </figure>
                                <div class="block-4-text p-4">
                                    <h3><a href="#">Real Madrid theo sát Arnold</a></h3>
                        ...
                        <div class="item">
                            <div class="block-4 text-center">
                                <figure class="block-4-image">
                                    <img src="/client/images/NH2.jpg" alt="Image placeholder" class="img-fluid">
                                </figure>
                                <div class="block-4-text p-4">
                                    <h3><a href="#">Morata chính thức gia nhập AC Milan</a></h3>
                                    <p class="mb-0">Finding perfect products</p>
                        ...
                        <div class="item">
                            <div class="block-4 text-center">
                                <figure class="block-4-image">
                                    <img src="/client/images/NH3.jpg" alt="Image placeholder" class="img-fluid">
                                </figure>
                                <div class="block-4-text p-4">
                                    <h3><a href="#">Man City vượt Barca, giành ưu thế chiêu mộ Vua phá lưới EURO</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="item">
